...
public class RayCastController {
    protected const float SKIN_WIDTH = 0.065f;
    ...
    public bool IsWallSliding { get { return CheckWallSliding(); } }
    ...
    protected bool CheckWallSliding() {
        return IsHittingWall == true && IsGrounded == false && movement.MyBody.velocity.y < 0f;
    }
    ...
    protected void DetectWall() {
        for (int i = 0; i < horizontalRayCount; i++) {
            ...
            RaycastHit2D hit = Physics2D.Raycast(rayOrigin, direction, 0.25f /*+ SKIN_WIDTH*/, movement.groundLayer);
    ...
    private void CheckGround() {
        ...
        for (int i = 0; i < verticalRayCount; i++) {
            ...
            Vector2 rayOrigin = movement.MyBody.velocity.y > 0 ? rayOrigins.topLeft : rayOrigins.bottomLeft;
            Vector2 rayDirection = movement.MyBody.velocity.y > 0 ? Vector2.up : Vector2.down;
